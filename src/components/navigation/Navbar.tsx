...
export const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'fixed inset-0 top-[60px] bg-slate-950 backdrop-blur-3xl z-[60] lg:hidden flex flex-col justify-between p-6 transition-all duration-400 ease-in-out border-t border-white/10',
