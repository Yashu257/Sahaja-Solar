...
export const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'fixed inset-0 top-[60px] bg-slate-900/70 backdrop-blur-2xl z-40 lg:hidden flex flex-col justify-between p-6 transition-all duration-400 ease-in-out border-t border-white/10',
